public class Student {
    ...
    public void calcAvarage() {
        double a = (this.fizik.note * 0.75 + this.fizik.sozlu * 0.25);
        double b = (this.kimya.note * 0.75 + this.kimya.sozlu * 0.25);
        double c = (this.mat.note * 0.75 + this.mat.sozlu * 0.25);
        this.avarage = (a + b + c) / 3;
    }
